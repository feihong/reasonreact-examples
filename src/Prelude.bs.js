...
function arrayRandGet(a) {
  return Belt_Array.get(a, Random.$$int(a.length));
}

function choose2(a1, a2, fn) {
  var match = arrayRandGet(a1);
  var match$1 = arrayRandGet(a2);
  if (match !== undefined && match$1 !== undefined) {
    return Curry._2(fn, Caml_option.valFromOption(match), Caml_option.valFromOption(match$1));
  } else {
    return /* () */0;
  }
}
